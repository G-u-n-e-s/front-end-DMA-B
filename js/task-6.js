...
//             this.precentOfMinPayment += (pay - this.balance) * 5 / 100
//             this.balance = 0 - (pay - this.balance);

//             return balansınız ${ this.balance } kredit limitiniz ${ this.creditLimit };
//         } else if (this.creditLimit >= pay) {
//             this.creditLimit -= pay
//             return balansınız ${ this.balance } kredit limitiniz ${ this.creditLimit };
//         } else {
...
// console.log(creditCard.withDraw(1000));
// console.log(creditCard.withDraw(100));
